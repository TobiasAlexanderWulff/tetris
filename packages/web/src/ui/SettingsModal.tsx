    ...
    <div style={overlay} role="dialog" aria-modal="true" aria-label="settings">
      <div style={panel}>
        ...
        <div style={content} aria-label="settings-content">
                  ...
                  onChange={(e) =>
                    setSettings({
                      mouseSensitivityPxPerCell: e.target.checked
                        ...
                        : Math.max(
                            8,
                            typeof settings.mouseSensitivityPxPerCell === 'number'
          ...
          <div style={row}>
            <label htmlFor="touchControlsMode">Touch Controls</label>
            <select
              id="touchControlsMode"
              style={input}
              value={settings.touchControlsMode}
              onChange={(event: React.ChangeEvent<HTMLSelectElement>) =>
                setSettings({
                  touchControlsMode: event.target.value as 'auto' | 'on' | 'off',
                })
              }
            >
          ...
          <div style={row}>
            ...
            <input
              ...
              onChange={(e) =>
                setSettings({ audio: { ...settings.audio, master: Number(e.target.value) } })
              }
            />
          </div>
          <div style={{ ...row, gridTemplateColumns: 'auto 1fr' }}>
            ...
            <input
              ...
              onChange={(e) =>
                setSettings({ audio: { ...settings.audio, muted: e.target.checked } })
              }
            />
          </div>
          <div style={section}>
